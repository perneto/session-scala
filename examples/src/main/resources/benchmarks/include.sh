...
RUNTIME_LIB=$RT_LIB_DIR/amqp-client-2.2.0.jar:$RT_LIB_DIR/commons-cli-1.1.jar:$RT_LIB_DIR/commons-io-1.2.jar:$RT_LIB_DIR/scalaj-collection_2.8.0-1.0.jar
...
start_role() {
  ...
  echo "Client role $1 : scala exited" 
}
